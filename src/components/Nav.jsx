...
const Nav = () => {
  ...
  return (
    <div className="flex justify-between mt-[32px] mx-[15px] ">
      ...
      <div className={`flex flex-col items-center ${closeNav ? 'hidden' : ''}`} onClick={handleCloseNav}>
        <MenuLogo />
        <p className="text-[8px]" >MENU</p>
      </div>
      <div className={`flex justify-between fixed top-0 right-0 bg-slate-500 opacity-80 h-screen w-3/4 transition-transform duration-500 transform ${closeNav ? 'translate-x-0' : 'translate-x-full'}`}>
        <ul className="text-white mx-4 my-2">
          <li className="transition-transform duration-200 transform hover:translate-x-5 hover:underline"><a href="">How it works</a></li>
          <li className="transition-transform duration-200 transform hover:translate-x-5 hover:underline"><a href="">Products</a></li>
          <li className="transition-transform duration-200 transform hover:translate-x-5 hover:underline"><a href="">Pricing</a></li>
          <li className="transition-transform duration-200 transform hover:translate-x-5 hover:underline"><a href="">Resources</a></li>
        </ul>
